      ...
      <section className="py-20 bg-[#dcdcdc] px-6 md:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <h4 className="font-bold text-[#333]"> NGO Partner</h4>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md">
            <p className="italic text-[#555] mb-2">
              “We’ve seen a huge improvement in how we distribute food. ZeroWaste made it seamless.”
            </p>
            <h4 className="font-bold text-[#333]">Volunteer</h4>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md">
            <p className="italic text-[#555] mb-2">
              “Thanks to ZeroWaste, we’ve been able to provide meals to families in need every day.”
            </p>
            <h4 className="font-bold text-[#333]"> Shelter Manager</h4>
          </div>
        </div>
      </section>
